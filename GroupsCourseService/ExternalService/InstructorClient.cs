...
namespace GroupsCourseService.ExternalService
{
    public class InstructorClient
    {
        ...
        public InstructorClient(GroupsCourseDbContext context, IConsulClient consulClient, HttpClient httpClient)
        {
            _context = context;
        ...
        public async Task<GeneralResponse<string>> GetByIdAsync(Guid instructorId)
        {
